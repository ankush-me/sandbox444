...
class InitInfo(genpy.Message):
  _md5sum = "47565f315bb0e1a0dffdb25437d7b98a"
  _type = "surgical_msgs/InitInfo"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# Defines CUTS and HOLES and the reference point-cloud
...
"""
  __slots__ = ['holes','cuts','cloud']
  _slot_types = ['surgical_msgs/Hole[]','surgical_msgs/Cut[]','sensor_msgs/PointCloud2']
